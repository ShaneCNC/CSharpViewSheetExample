This template is a standard C# class library project for use with Mastercam 2018 The project 
...
**NOTE: This NET-Hook class library targets the .NET 4.5.2 Framework x64 build.
...
Visual Studio 2018 Community Edition (Free) is recommended if you are using the previous Visual Studio Express Edition.
https://www.visualstudio.com/en-us/downloads/download-visual-studio-vs.aspx


** POST BUILD STEP **

copy "$(TargetPath)" "C:\Program Files\mcam2018\chooks\$(TargetFileName)"
copy "$(ProjectDir)FunctionTable\$(TargetName).ft" "C:\Program Files\mcam2018\chooks\$(TargetName).ft"


** DEBUGGING **

Start External Application -> C:\Program Files\mcam2018\Mastercam.exe

Working Directory -> C:\Program Files\mcam2018